package com.inkamedia.inkacast.HosLayer.WebModule.adapters
...
import com.inkamedia.inkacast.databinding.TabBinding
    ...
    override fun onBindViewHolder(holder: MyHolder, position: Int) {
        ...
        holder.cancelBtn.setOnClickListener {
            if(MainActivity.tabsList.size == 1 || position == MainActivity.myPager.currentItem)
                Snackbar.make(MainActivity.myPager, "No puedes Cerrar esta pestana", 3000).show()
            else{
